...
TARGET = "rec_sunscreen"  # Sunscreen target
...
# Save target encoder for later
with open("sunscreen_target_encoder.pkl", "wb") as f:
...
# ------------------------------
model.save_model("sunscreen_model.txt")
print("✅ Sunscreen model trained and saved as sunscreen_model.txt")
