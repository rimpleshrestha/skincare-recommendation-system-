...
TARGET = "avoid_ingredients"  # Avoid Ingredients target
...
# Save target encoder
with open("avoid_ingredients_target_encoder.pkl", "wb") as f:
...
# ------------------------------
model.save_model("avoid_ingredients_model.txt")
print("✅ Avoid Ingredients model trained and saved as avoid_ingredients_model.txt")
