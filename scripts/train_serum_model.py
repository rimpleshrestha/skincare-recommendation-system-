...
with open("serum_target_encoder.pkl", "wb") as f:
...
# ------------------------------
model.save_model("serum_model.txt")
print("✅ Serum model trained and saved as serum_model.txt")
